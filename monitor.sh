...
while true; do
  payload=$(curl -s -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"eth_blockNumber","params":[],"id":1}' 'https://arb-sepolia.g.alchemy.com/v2/\$ALCHEMY_API_KEY')
